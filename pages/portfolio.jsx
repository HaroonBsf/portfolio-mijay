...
export default function Portifolio() {
    ...
    const orderedProjects = [
        ...
        { id: 16, title: "News App", category: "Mobile application", linkUrl: null, description: "Compact news reader with headlines, article previews and a simple, fast navigation.", imageSourcePath: "/img/portfolio-projects/project-16.jpg", techs: [] },
        { id: 17, title: "Blood Bank App", category: "Mobile application", linkUrl: null, description: "Donation tracking, nearby centers and appointment scheduling flows in a friendly UI.", imageSourcePath: "/img/portfolio-projects/project-17.jpg", techs: [] },
        { id: 18, title: "Summary", category: "Web development", linkUrl: null, description: "Executive dashboard with KPIs, cards and table snapshots presented in a clean layout.", imageSourcePath: "/img/portfolio-projects/project-18.png", techs: [] },
        { id: 19, title: "Arrival", category: "Web development", linkUrl: null, description: "Automotive analytics overview—dark theme charts and multi‑screen telemetry views.", imageSourcePath: "/img/portfolio-projects/project-19.png", techs: [] },
    ];
